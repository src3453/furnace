...
const char* aboutLine[]={
  ...
  "",
  ("FurnaceMod v3.0 Based on Furnace " DIV_VERSION),
  "",
  _N("a fork of the biggest multi-system chiptune tracker!"),
  _N("featuring the 3HS88PWN4 Fantasy chip and bunch of improvements (and deprovements)!"),
  "",
  _N("> CREDITS <"),
  "",
  _N("-- program --"),
  ...
  _N("3HS88PWN4 (s3hs_core) by src3453"),
  _N("CPT100, 3FS44U by src3453"),
